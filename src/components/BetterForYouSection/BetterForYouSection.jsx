...
import refillPackImage from "../../assets/Refill_Packaging_Mockup_2/Refill_Packaging_Mockup_2.png";
import refillPackImageHD from "../../assets/Refill_Packaging_Mockup_2/Refill_Packaging_Mockup_2@2x.png";
  ...
  return (
    <div className="better-for-section">
      ...
      <div className="better-for-section__right-group">
        ...
        <Button buttonTitle="Subscribe now" type="secondary" />
      </div>
    </div>
  );
}
